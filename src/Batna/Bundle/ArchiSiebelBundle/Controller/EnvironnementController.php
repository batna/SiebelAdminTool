...
use Batna\Bundle\ArchiSiebelBundle\Form\EnvironnementType;
...
class EnvironnementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BatnaArchiSiebelBundle:Environnement')->findAll();

        return $this->render('BatnaArchiSiebelBundle:Environnement:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BatnaArchiSiebelBundle:Environnement')->find($id);
        ...
        return $this->render('BatnaArchiSiebelBundle:Environnement:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BatnaArchiSiebelBundle:Environnement:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BatnaArchiSiebelBundle:Environnement:edit.html.twig', array(
            'entity'      => $entity,
