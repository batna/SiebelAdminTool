...
use Batna\Bundle\ArchiSiebelBundle\Form\HostType;
...
class HostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BatnaArchiSiebelBundle:Host')->findAll();

        return $this->render('BatnaArchiSiebelBundle:Host:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BatnaArchiSiebelBundle:Host')->find($id);
        ...
        return $this->render('BatnaArchiSiebelBundle:Host:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('BatnaArchiSiebelBundle:Host:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BatnaArchiSiebelBundle:Host:edit.html.twig', array(
            'entity'      => $entity,
