...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BatnaArchiSiebelBundle', '/var/www/Symfony/app/Resources/BatnaArchiSiebelBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BatnaArchiSiebelBundle', '/var/www/Symfony/src/Batna/Bundle/ArchiSiebelBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineFixturesBundle', '/var/www/Symfony/app/Resources/DoctrineFixturesBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineFixturesBundle', '/var/www/Symfony/vendor/bundles/Symfony/Bundle/DoctrineFixturesBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BatnaUserBundle', '/var/www/Symfony/app/Resources/BatnaUserBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BatnaUserBundle', '/var/www/Symfony/src/Batna/Bundle/UserBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, array(0 => '/var/www/Symfony/src/Batna/Bundle/ArchiSiebelBundle/Entity', 1 => '/var/www/Symfony/src/Batna/Bundle/UserBundle/Entity'));

        $h = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $h->addDriver($e, 'FOS\\UserBundle\\Entity');
        $h->addDriver($g, 'Batna\\Bundle\\ArchiSiebelBundle\\Entity');
        $h->addDriver($g, 'Batna\\Bundle\\UserBundle\\Entity');

        $i = new \Doctrine\ORM\Configuration();
        $i->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'BatnaArchiSiebelBundle' => 'Batna\\Bundle\\ArchiSiebelBundle\\Entity', 'BatnaUserBundle' => 'Batna\\Bundle\\UserBundle\\Entity'));
        $i->setMetadataCacheImpl($b);
        $i->setQueryCacheImpl($c);
        $i->setResultCacheImpl($d);
        $i->setMetadataDriverImpl($h);
        $i->setProxyDir('/var/www/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'c79ea95a1d7b9191628b9dbf71721592');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Batna\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Batna\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Entity\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getEntityManager(NULL), 'Batna\\Bundle\\UserBundle\\Entity\\User');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/Symfony/app/cache/dev/translations', 'debug' => true), $this->get('session'));
        ...
        $instance->addResource('xliff', '/var/www/Symfony/src/Batna/Bundle/ArchiSiebelBundle/Resources/translations/messages.fr.xliff', 'fr', 'messages');
        $instance->addResource('xliff', '/var/www/Symfony/src/Batna/Bundle/UserBundle/Resources/translations/messages.fr.xliff', 'fr', 'messages');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BatnaArchiSiebelBundle' => 'Batna\\Bundle\\ArchiSiebelBundle\\BatnaArchiSiebelBundle',
                'DoctrineFixturesBundle' => 'Symfony\\Bundle\\DoctrineFixturesBundle\\DoctrineFixturesBundle',
                'BatnaUserBundle' => 'Batna\\Bundle\\UserBundle\\BatnaUserBundle',
            ...
            'mailer_password' => '',
            'locale' => 'fr',
            'secret' => 'c79ea95a1d7b9191628b9dbf71721592',
            ...
            'kernel.secret' => 'c79ea95a1d7b9191628b9dbf71721592',
            ...
            'fos_user.model.user.class' => 'Batna\\Bundle\\UserBundle\\Entity\\User',
