...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/Symfony/src/Batna/Bundle/ArchiSiebelBundle/Entity')), 'Batna\\Bundle\\ArchiSiebelBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BatnaArchiSiebelBundle' => 'Batna\\Bundle\\ArchiSiebelBundle\\Entity'));
