...
<div class=\"mws-panel grid_8\">
        ...
        echo "\" class=\"mws-ic-16 ic-page\">Nouveau server</a>
                                        </li>
                                </ul>
                        </div>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            <td class=\"\">
                <a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("siebelserver_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
