...
class __TwigTemplate_feeeea00489ae6269e94a8a4e7812c76 extends Twig_Template
{
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - Liste des enterprise servers";
    }
    ...
    <div class=\"mws-panel-body\">
        <div class=\"mws-panel-toolbar top clearfix\">
            <ul>
                <li><a href=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("es_new"), "html", null, true);
        echo "\" class=\"mws-ic-16 ic-page\">Nouvel enterprise</a></li>
            </ul>
        </div>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            <td>
                <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("es_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\"><div class=\"clearfix mws-ic-16 ic-view\" style=\"width:20px;float:left;\">&nbsp;</div></a>
                <a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("es_edit", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\"><div class=\"clearfix mws-ic-16 ic-edit\" style=\"width:20px;float:left;\">&nbsp;</div></a>
                <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("es_delete", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
